      ...
      <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="lg1" x1="0" y1="0" x2="48" y2="48" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#C8F04A" />
            <stop offset="100%" stopColor="#9BB832" />
          </linearGradient>
        </defs>
        <rect x="2" y="2" width="44" height="44" rx="10" fill="#1E2A14" stroke="#C8F04A" strokeWidth="1" strokeOpacity="0.3" />
        <g stroke="#C8F04A" strokeWidth="1" strokeLinecap="round" opacity="0.35">
        ...
        <circle cx="14" cy="15" r="3" fill="#C8F04A" />
        <circle cx="34" cy="15" r="3" fill="#9BB832" />
        <circle cx="24" cy="21" r="4" fill="url(#lg1)" />
        <circle cx="24" cy="30" r="3.5" fill="url(#lg1)" />
        <circle cx="14" cy="35" r="2.5" fill="#C8F04A" opacity="0.6" />
        <circle cx="34" cy="35" r="2.5" fill="#C8F04A" opacity="0.6" />
